...
interface ForecastProgramContextInterface {
  ...
  programError: null | IError;
  setProgramError: Dispatch<SetStateAction<IError | null>>;
  dailyError: null | IError;
  setDailyError: Dispatch<SetStateAction<IError | null>>;
...
export default function ForecastContextProvider({
  ...
  const [programError, setProgramError] = useState<null | IError>(null);
  const [dailyError, setDailyError] = useState<null | IError>(null);
